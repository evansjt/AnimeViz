...
const layout = { title: '<b>Average Membership of Anime Media Released per Year</b><br><i style="font-size:12px">(Raw data can be seen with API extension: /avg-mem-per-yr)</i>', xaxis: { title: 'Year' }, yaxis: { title: '# of Avg. members' }, width: window.innerWidth, legend: { title: { text: "<b>Media Types<b>", font: { size: 14 }, side: "top" }, orientation: "h", bgcolor: '#E2E2E2', bordercolor: '#FFFFFF', borderwidth: 2 }, annotations: [{ xref: 'paper', yref: 'paper', xanchor: 'left', yanchor: 'bottom', x: 0, y: 1, text: '<i>OVA* = Original video animation (direct-to-video anime)</i><br><i>ONA* = Original net animation (direct-to-internet anime)</i>', font: { size: 10 }, align: 'left', showarrow: false }] };
