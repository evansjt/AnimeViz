...
FROM (SELECT COALESCE(title_english,title) AS "Title", episodes AS "# Episodes", aired_from AS "Aired From", COALESCE(aired_to, CURRENT_DATE) AS "Aired To", aired_to - aired_from AS "Time Aired"
FROM anime
